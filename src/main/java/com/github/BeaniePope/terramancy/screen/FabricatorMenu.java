package com.github.BeaniePope.terramancy.screen;
...
import com.github.BeaniePope.terramancy.screen.slot.modResultSlot;
...
public class FabricatorMenu extends AbstractContainerMenu {
    ...
    public FabricatorMenu(int pContainerId, Inventory inv, BlockEntity entity) {
        ...
        this.blockEntity.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY).ifPresent(handler -> {
            ...
            this.addSlot(new SlotItemHandler(handler, 1, 10, 10));
            this.addSlot(new SlotItemHandler(handler, 2, 20, 20));
            this.addSlot(new SlotItemHandler(handler, 3, 30, 30));
            this.addSlot(new SlotItemHandler(handler, 4, 40, 40));
            this.addSlot(new SlotItemHandler(handler, 5, 50, 50));
            this.addSlot(new SlotItemHandler(handler, 6, 60, 60));
            this.addSlot(new SlotItemHandler(handler, 7, 70, 70));
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, modBlocks.FABRICATOR_BLOCK.get());
    }
